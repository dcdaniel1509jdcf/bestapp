                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-md-6">
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $factura['factura'] }}" class="form-control" required placeholder="Factura">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="text"
                                                                    name="facturas[{{ $index }}][valor]"
                                                                    value="{{ $factura['valor'] }}" class="form-control dineroCamp valor" required placeholder="Valor">
                                                            </div>
                                                            <div class="col-md-2">
